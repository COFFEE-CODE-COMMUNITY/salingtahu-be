...
export class ChangePasswordBadRequestResponseDto extends BadRequestResponseDto<ChangePasswordErrorMessage> {
  @ApiProperty({
    description: "Detailed validation errors for each field in the change password request",
